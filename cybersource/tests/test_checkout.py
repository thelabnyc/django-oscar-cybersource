...
class CheckoutIntegrationTest(BaseCheckoutTest):
    ...
    def test_checkout_process(self):
        ...
        self.assertEqual(resp.data['payment_method_states']['cybersource']['required_action']['name'], 'get-token-and-authorize')
...
class CybersourceMethodTest(BaseCheckoutTest):
    ...
    def test_request_auth_form_success(self, pre_calculate_total, pre_build_auth_request):
        product = self.create_product()
